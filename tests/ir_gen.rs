...
fn test_irgen_class_vtable_global() {
    ...
    assert!(
        llvm_ir.contains("_T$test$$__vtable$Animal"),
...
fn test_irgen_class_vtable_method_call_is_indirect() {
    ...
    assert!(
        llvm_ir.contains("_T$test$$__vtable$Greeter"),
...
fn test_irgen_class_inheritance_vtable_inherited_methods() {
    ...
    assert!(
        llvm_ir.contains("_T$test$$__vtable$Dog"),
        "Expected vtable.Dog:\n{}",
        llvm_ir
    );
    assert!(
...
fn test_irgen_protocol_witness_table_for_class() {
    ...
    assert!(
        llvm_ir.contains("_T$test$$Drawable$__protocol_wt$test$$Circle"),
...
fn test_irgen_compound_protocol_existential_dispatch() {
    ...
    assert!(
        llvm_ir.contains("_T$test$$Resettable$__protocol_wt$test$$Circle"),
...
fn test_irgen_class_computed_property_inheritance_override() {
    ...
    assert!(
        llvm_ir.contains("_T$test$$__vtable$Base"),
        "vtable.Base should exist:\n{}",
        llvm_ir
    );
    assert!(
        llvm_ir.contains("_T$test$$__vtable$Derived"),
...
fn test_irgen_class_stored_property_auto_getter_setter() {
    ...
    assert!(
        llvm_ir.contains("_T$test$$__vtable$Data"),
        "vtable should exist:\n{}",
        llvm_ir
    );
    assert!(
...
fn test_irgen_extension_protocol_witness_table() {
    ...
    assert!(
        llvm_ir.contains("_T$test$$P$__protocol_wt$$$Foo"),
